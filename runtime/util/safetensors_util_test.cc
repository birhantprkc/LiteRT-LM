...
TEST(SafetensorsUtilTest, BuildSafetensorsHeaderWithMetadata) {
  ...
  std::string header = BuildSafetensorsHeader("post_query", "F32", shape,
...
TEST(SafetensorsUtilTest, BuildSafetensorsHeaderWithoutMetadata) {
  ...
  std::string header =
      BuildSafetensorsHeader("embeddings", "F16", shape, /*total_bytes=*/32);
